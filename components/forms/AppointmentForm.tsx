...
// http://localhost:3000/patients/669fc2d0002ec008ffef/new-appointment
// http://localhost:3000/patient/669fc2d0002ec008ffef/new-appointment/success?appointmentId=undefined
    ...
    const onSubmit = async (values: z.infer<typeof AppointmentFormValidation>) => {
        ...
        try {
            if (type === "create" && patientId) {
                ...
                // Now we need a server action to create appointment 
    ...
    return (
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 flex-1">
                ...
                {/* We need to check if the type that we are receiving here in this component is not cancel */}
                {type !== 'cancel' && (
                    <>
                        <CustomFormField
